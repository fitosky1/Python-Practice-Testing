...
def max_sum_mult_in_nested(nested_list1, nested_list2):
    ...
    # tmp_mlist = [[0 for columns in range(ln1)] for rows in range(ln2)]
    # for i in range(ln1):
    #     for j in range(ln2):
    #         tmp_mlist[i][j] = (
    ...
    return(
        ...
        sum1,
        sum2)  # multiple outputs are a tuple


# print out
print(
    "maxs within (nested list1, max_i, max_j),(nested list1, max_i, max_j), sum_list1, sum_list2:\n",
